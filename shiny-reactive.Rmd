...
``` {r shiny-dev-workflow2, eval=FALSE}
library(shiny) 
ui <- fluidPage(
   sliderInput(inputId = "num",
     label = "Choose a number",      
...
``` {r shiny-dev-workflow-isolate, eval=FALSE}
library(shiny)
...
``` {r shiny-dev-workflow-event, eval=FALSE}
library(shiny)
...
``` {r shiny-dev-workflow-reactive, eval=FALSE}
library(shiny)
...
``` {r shiny-dev-workflow-state, eval=FALSE}
library(shiny)
